...
// Enhanced get project overview with access control
export const getProjectOverviewEnhanced = query({
  args: { 
...
// Enhanced get user dashboard with access control
export const getUserDashboardEnhanced = query({
...
// Enhanced get project statistics with access control
export const getProjectStatsEnhanced = query({
  args: { 
    projectId: v.id("projects"),
    userId: v.id("users")
  },
